       ...
       <div class="col-xl-3 col-md-6 mb-4">
         <div class="card border-left-success shadow h-100 py-2">
           <div class="card-body">
             <div class="row no-gutters align-items-center">
               <div class="col mr-2">
                 <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Rata-rata BMI Indonesia</div>
                 <div class="h5 mb-0 font-weight-bold text-gray-800">isi</div>
               </div>
               <div class="col-auto">
       ...
       <div class="col-xl-3 col-md-6 mb-4">
         <div class="card border-left-info shadow h-100 py-2">
           <div class="card-body">
             <div class="row no-gutters align-items-center">
               <div class="col mr-2">
                 <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Kategori BMI Anda
                 </div>
                 <div class="row no-gutters align-items-center">
                   <div class="col-auto">
             ...
             <div class="small">
               <form method="POST" enctype="multipart/form-data">
                 <div class="form-group" id="prefetch">
                   ...
                   <input type="text" name="namaM" class="form-control typeahead" placeholder="Search Here">
                 </div>
